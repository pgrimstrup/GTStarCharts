...
namespace PanasonicNZ.Common
{
    public class WpfScreen
    {
        ...
        public static double FontScaling(Window window)
        {
            double factor = System.Windows.PresentationSource.FromVisual(window).CompositionTarget.TransformToDevice.M11;
            return factor;
        }
